  ...
  return (
    <div>
      ...
      <div className="px-5 pb-8">
        <div className="text-xs font-semibold uppercase tracking-wide text-ink-dim mt-3 mb-1.5">
        ...
        <div className="py-3 border-b border-rule flex items-center justify-between gap-2">
        ...
        <div className="text-xs font-semibold uppercase tracking-wide text-ink-dim mt-6 mb-1.5">
          {t("settings.data")}
        </div>

        <Link href="/settings/backup" className="py-3 border-b border-rule flex items-center justify-between gap-3">
        ...
        <Link href="/settings/archived" className="py-3 border-b border-rule flex items-center justify-between gap-3">
          <div className="min-w-0">
        ...
        <button
          ...
          className="w-full py-3 border-b border-rule flex items-center justify-between text-left"
        >
          <span className="text-sm font-semibold text-ink">{t("menu.shareApp")}</span>
          <ChevronRight size={18} className="text-ink-dim" />
        </button>

        <div className="mt-6 rounded-2xl bg-accent-soft px-4 py-3.5 flex gap-3">
